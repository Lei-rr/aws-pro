...
import { loadAccounts, useAccountStore } from '@/features/accounts/model/accounts'
import { toast } from '@/shared/lib/toast'
import { errorMessage } from '@/shared/lib/errors'

const props = withDefaults(defineProps<{ modelValue?: string; disabled?: boolean; autoSelect?: boolean }>(), {
  autoSelect: true,
})
