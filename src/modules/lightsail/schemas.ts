import { boolQuery, objectSchema, optionalText, paramsSchema, requestSchema, text } from '../../lib/http/request-schema.js'
...
export const lightsailRemarkSchema = requestSchema({
  ...
  body: objectSchema({ ...accountRegion, instance_name: text(128), remark: optionalText(4096) }, ['account_id', 'region', 'remark']),
})
