import { bool, boolQuery, objectSchema, optionalText, paramsSchema, requestSchema, text } from '../../lib/http/request-schema.js'
...
export const ec2RemarkSchema = requestSchema({
  ...
  body: objectSchema({ ...accountRegion, instance_id: text(128), remark: optionalText(4096) }, ['account_id', 'region', 'remark']),
})
